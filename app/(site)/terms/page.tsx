...
export const metadata: Metadata = {
  title: "Terms & Conditions - BodyVisualizer",
  description: "Terms governing use of BodyVisualizer and its interactive body-composition modeling features.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16 max-w-4xl">
      ...
      <p className="mb-4 text-lg">
        These Terms govern your use of BodyVisualizer. By using this service, you agree to these terms.
      </p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">1. Service Scope</h2>
        <p>
          BodyVisualizer provides interactive body-composition visualization based on uploaded images and
      ...
      <section className="mb-8">
        ...
        <p>
          BodyVisualizer is not a medical or diagnostic tool. Do not rely on it as a substitute for professional
